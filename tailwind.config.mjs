...
// const primaryColor = "#E11D48"; // Neon Red
// const primaryColor2 = "#06B6D4"; // Bright Cyan
// const primaryColorLight = "#140c1c"; // Deep Magenta-Black
// const secondaryColor = "#9333EA"; // Vibrant Purple
// const bodyColor = "#dddddd"; // Neutral Light Gray
// const bodyColor2 = "#7A7A7A"; // Muted Gray
// const whiteColor = "#ffffff"; // Pure White
// const blackColor = "#050709"; // Deep Black
// const blackColor2 = "#0b0410"; // Rich Black
// const grayColor = "#636363"; // Neutral Gray
// const grayColor2 = "#747779"; // Cool Gray
// const grayColor3 = "#22272c"; // Charcoal Gray
// const borderColor = "#d9d9d9"; // Light Border Gray
// const creamLightColor = "#f6f3fc"; // Soft Off-White
// const darkColor = "#0f0715"; // Deep Magenta-Black
// const bgColor = "#10171c"; // Dark Blue-Gray
// const bgColor2 = "#FFFFFF1A"; // Transparent White
// const bgColor3 = "#d9d9d980"; // Transparent Gray
